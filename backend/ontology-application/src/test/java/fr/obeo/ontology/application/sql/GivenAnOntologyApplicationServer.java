 ...
 *******************************************************************************/
package fr.obeo.ontology.application.sql;
...
/**
 * Integration test annotation used to setup the database=
 *
 * @author fbarbin
 */
@Documented
...
@SqlGroup({
        @Sql(scripts = {
                "/scripts/ontology-test-database.sql"
...
public @interface GivenAnOntologyApplicationServer {
}
