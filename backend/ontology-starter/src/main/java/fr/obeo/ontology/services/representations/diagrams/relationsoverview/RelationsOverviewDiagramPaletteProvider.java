 ...
 *******************************************************************************/
package fr.obeo.ontology.services.representations.diagrams.relationsoverview;
 ...
 * @author ntinsalhi
 */
public class RelationsOverviewDiagramPaletteProvider {

    protected final ViewBuilders viewBuilderHelper;

    private final DiagramBuilders diagramBuilderHelper;

    public RelationsOverviewDiagramPaletteProvider(DiagramBuilders diagramBuilderHelper) {
    ...
    public DropTool createDropFromExplorerTool() {
       var dropElementFromExplorer = this.viewBuilderHelper.newChangeContext()
                        .expression("aql:self.dropIntoDiagramFromExplorer(selectedNode, editingContext, diagramContext, convertedNodes)")
                        .build();
