...
/**
 * This is the central singleton for the Ontology edit plugin. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public final class OntologyEditPlugin extends EMFPlugin {
    ...
    public OntologyEditPlugin() {
        super(new ResourceLocator[] { EntityEditPlugin.INSTANCE, EnvironmentEditPlugin.INSTANCE, TechnicalIDEditPlugin.INSTANCE, });
    }
