 ...
 * @author lfasani
 */
@MutationDataFetcher(type = "Mutation", field = "uploadOWLFile")
public class MutationUploadOWLDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationUploadOWLDataFetcher(IEditingContextDispatcher editingContextDispatcher, IMessageService messageService, ObjectMapper objectMapper) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        if (optionalId.isPresent() && optionalEditingContextId.isPresent() && optionalFile.isPresent()) {
            ...
            var input = new UploadOWLInput(id, editingContextId, file);
