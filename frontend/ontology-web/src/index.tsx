...
import { obeoCloudPlatformOptions } from '@obeo/obeo-cloud-platform';
...
//   identifier: `ontology_${treeItemContextMenuEntryExtensionPoint.identifier}_document`,
...
extensionRegistry.addAll(obeoCloudPlatformOptions.extensionRegistry, extensionRegistryMergeStrategy);
